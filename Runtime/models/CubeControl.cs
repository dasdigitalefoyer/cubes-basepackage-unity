namespace PuzzleCubes
{
    namespace Models
    {
        ...
        public class CubeControl : BaseData
        {
            ...
            [UnityEngine.SerializeField] private UnityEngine.Vector2 position = new UnityEngine.Vector2(0, 0);
            [UnityEngine.SerializeField] private float orientation = 0;
            [UnityEngine.SerializeField] private UnityEngine.Vector2 velocity = new UnityEngine.Vector2(0, 0);
